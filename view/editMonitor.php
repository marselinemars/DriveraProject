...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Edit Monitor</title>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						<form  id="monitor_credentials" method="post" action=<?php echo "index.php?action=do_edit_monitor&idm=$idm" ?>  >
						<?php
						 $idm=$_GET["idm"];
						 $monitor= $db->query("SELECT * FROM monitor where IDM= ? ", $idm)->fetchAll(); 
						 ?>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										name="fname"
										value="<?php echo $monitor [0] ['fname']; ?>"
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="search"
										name="lname"
										value="<?php echo $monitor [0]['lname']; ?>"
									/>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select name ="gender" form="monitor_credentials"class="custom-select col-12">
										...
										<option value="male" <?php if ($monitor[0] ['gender'] === 'male') echo 'selected'; ?>>Male</option>
										<option value="female" <?php if ($monitor[0] ['gender'] === 'female') echo 'selected'; ?>>Female</option>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select name ="bgroup" form="monitor_credentials"class="custom-select col-12">
										<option selected="">Choose...</option>
										<option value="o+" <?php if ($monitor[0] ['bgroup'] === 'o+') echo 'selected'; ?>>o+</option>
										<option value="o-" <?php if ($monitor[0] ['bgroup'] === 'o-') echo 'selected'; ?>>o-</option>
										<option value="b+" <?php if ($monitor[0] ['bgroup'] === 'b+') echo 'selected'; ?>>b+</option>
										<option value="b-" <?php if ($monitor[0] ['bgroup'] === 'b-') echo 'selected'; ?>>b-</option>
										<option value="a+" <?php if ($monitor[0] ['bgroup'] === 'a+') echo 'selected'; ?>>a+</option>
										<option value="a-" <?php if ($monitor[0] ['bgroup'] === 'a-') echo 'selected'; ?>>a-</option>
										<option value="ab+" <?php if ($monitor[0] ['bgroup'] === 'ab+') echo 'selected'; ?>>ab+</option>
										<option value="ab-" <?php if ($monitor[0] ['bgroup'] === 'ab-') echo 'selected'; ?>>ab-</option>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="tel"
										name="phone"
										value="<?php echo $monitor[0] ['phone_num']; ?>"
									/>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="text"
										name="address"
										value="<?php echo $monitor[0]['address']; ?>"
									/>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control"  type="text" name="email" value="<?php echo $monitor[0]['email']; ?>"/>
								</div>
							</div>
