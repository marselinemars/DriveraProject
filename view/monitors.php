								...
								<td>
											<div class="dropdown">
												...
												<div
													class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list"
												>
													<a class="dropdown-item" href="index.php?action=monitor_profile&index=<?php echo $i; ?>"
														><i class="dw dw-eye"></i> View</a
													>
													<a class="dropdown-item" href="index.php?action=edit_monitor&idm=<?php echo $idmonitor; ?>"
														><i class="dw dw-edit2"></i> Edit</a
													>
													<a class="dropdown-item" href="index.php?action=delete_monitor&idmonitor=<?php echo $idmonitor; ?>"
