...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Failed Students </title>
		...
		<div class="main-container">
					...
					<div class="card-box mb-30">
						...
						<div class="pb-20">
							...
							>
								...
								<thead>
									<tr>
										<th class="table-plus datatable-nosort">studentID</th>
										<th>first_name</th>
										<th>last_name</th>
										<th>stage</th>
										<th>category</th>
          ...
          <?php 
            for ($i=0;$i<count($items);$i++){
				$idstudent=$items[$i]['studentID'];
            ?>
            <tr>
										<td class="table-plus"><?php echo htmlspecialchars($items[$i]['studentID']);?> </td>
										<td><?php echo htmlspecialchars($items[$i]['first_name']);?></td>
										<td><?php echo htmlspecialchars($items[$i]['last_name']);?></td>
										<td><?php echo htmlspecialchars($items[$i]['stage']);?></td>
										<td><?php echo htmlspecialchars($items[$i]['category']);?></td>
										<td><?php echo htmlspecialchars($items[$i]['result']);?></td>
