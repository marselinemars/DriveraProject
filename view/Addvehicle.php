...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Add vehicle</title>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						<form  id="vehicle_credentials" method="post" action="index.php?action=do_add_vehicle"  >
						<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label" >Category </label>
								<div class="col-sm-12 col-md-10">
									<select name ="Category" form="vehicle_credentials"class="custom-select col-12">
                            ...
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Insurance Policy Number</label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
