...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | student Profile </title>
					...
					<div class="row">
						<div style="width:100%;">
							<div class="pd-20 card-box height-100-p">
                                ...
                                <?php $row = $_GET["row"] ;?>
								<h5 class="text-center h5 mb-0"><?php echo htmlspecialchars($student_rows[$row]['fname']) . " " . htmlspecialchars($student_rows[$row]['lname']) ;?></h5>
								...
								<div class="profile-info">
									...
									<li>
											...
											<?php echo htmlspecialchars($student_rows[$row]['fname']);?>
										</li>
										<li>
											<span>Last Name:</span>
											<?php echo htmlspecialchars($student_rows[$row]['lname']);?>
										</li>

										<li>
											<span>Email Address:</span>
											<?php echo htmlspecialchars($student_rows[$row]['email']);?>
										</li>
										<li>
											<span>Phone Number:</span>
											<?php echo htmlspecialchars($student_rows[$row]['phone_num']);?>
										</li>
										<li>
											<span>Birth date</span>
											<?php echo htmlspecialchars($student_rows[$row]['bday']) ;?>
										</li>
										<li>
											<span>Place Of Birth</span>
											<?php echo htmlspecialchars($student_rows[$row]['PlaceOfBirth']) ;?>
										</li>
                                        <li>
											<span>Address:</span>
											<?php echo htmlspecialchars($student_rows[$row]['address']);?>
										</li>
										<li>
											<span>Nationality</span>
											<?php echo htmlspecialchars($student_rows[$row]['Nationality']) ;?>
										</li>
										<li>
											<span>Category</span>
											<?php 
											    $category_query = $db->query("SELECT * FROM Category WHERE CategoryID = ? ", $student_rows[$row]['CategoryID']);
												$category = $category_query->fetchArray();
											echo htmlspecialchars($category['CategoryName']);?>
										</li>
										<li>
											<span>Category Of Previous License:</span>
											<?php echo htmlspecialchars($student_rows[$row]['PriviousLicenseCategory']);?>
										</li>
										<li>
											<span>Date Of Previous License:</span>
											<?php echo htmlspecialchars($student_rows[$row]['PriviousLicenseDate']);?>
										</li>
							
										<li>
											<span>gender :</span>
											<?php echo htmlspecialchars($student_rows[$row]['gender']);?>
										</li>
										<li>
											<span>Blood :</span>
											<?php echo htmlspecialchars($student_rows[$row]['bgroup']);?>
										</li>
										
										<li>
											<span>Total paid</span>
											<?php echo htmlspecialchars($student_rows[$row]['TotalPaid']);?>
										</li>
										<li>
											<span>Stage :</span>
											<?php echo htmlspecialchars($student_rows[$row]['Stage']);?>
										</li>
										<li>
											<span>The Number of Attended Hours :</span>
											<?php echo htmlspecialchars($student_rows[$row]['NumOfAttendantHours']);?>
										</li>
