...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Edit Student</title>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						<form  id="student_credentials" method="post" action=<?php echo "index.php?action=do_edit_student&idstudent=$idstudent" ?> >
						<?php
						 $idstudent=$_GET["idstudent"];
						 $student= $db->query("SELECT * FROM student where IDS= ? ", $idstudent)->fetchAll(); 
						 ?>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										name="fname"
										value="<?php echo $student [0] ['fname']; ?>"
									/>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="search"
										name="lname"
										value="<?php echo $student [0] ['lname']; ?>"
									/>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select name ="gender" form="student_credentials"class="custom-select col-12">
										...
										<option value="male" <?php if ($student[0] ['gender'] === 'male') echo 'selected'; ?>>Male</option>
										<option value="female" <?php if ($student[0] ['gender'] === 'female') echo 'selected'; ?>>Female</option>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="tel"
										name="phone"
										value="<?php echo $student [0] ['phone_num']; ?>"
									/>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										type="text"
										name="address"
										value="<?php echo $student [0] ['address']; ?>"
									/>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" value="<?php echo $student [0] ['email']; ?>" type="text" name="email"/>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Total Paid	</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" value="<?php echo $student [0] ['TotalPaid']; ?>" type="text" name="totalpaid"/>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									...
									<option selected="">Choose...</option>
										<option value="o+" <?php if ($student[0] ['bgroup'] === 'o+') echo 'selected'; ?>>o+</option>
										<option value="o-" <?php if ($student[0] ['bgroup'] === 'o-') echo 'selected'; ?> >o-</option>
										<option value="b+" <?php if ($student[0] ['bgroup'] === 'b+') echo 'selected'; ?>>b+</option>
										<option value="b-" <?php if ($student[0] ['bgroup'] === 'b-') echo 'selected'; ?>>b-</option>
										<option value="a+" <?php if ($student[0] ['bgroup'] === 'a+') echo 'selected'; ?>>a+</option>
										<option value="a-" <?php if ($student[0] ['bgroup'] === 'a-') echo 'selected'; ?>>a-</option>
										<option value="ab+" <?php if ($student[0] ['bgroup'] === 'ab+') echo 'selected'; ?>>ab+</option>
										<option value="ab-" <?php if ($student[0] ['bgroup'] === 'ab-') echo 'selected'; ?>>ab-</option>
									</select>
								</div>
							</div>
