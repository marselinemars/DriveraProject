...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Edit Payment</title>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Payment Information <?php echo $idpayment?> </h4>
								<p class="mb-30">Please Enter The Payment Information Carefully</p>
                        ...
                        <?php  $idpayment = $_GET["idpayment"];?>
						<form  id="payment_credentials"  method="post" action=<?php echo "index.php?action=do_edit_payment&idpayment=$idpayment" ?>>
                            ...
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"> Date of Payment: </label>
								<div class="col-sm-12 col-md-10">
									<input
                            ...
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"> Next Date for Payment: </label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control datetimepicker"
										placeholder=" "
								...
								<br><br><br>
									...
									<div class="wrapper">
										<button class="" type="submit" form="payment_credentials">
										  <span>add </span>
										  <div class="success">
