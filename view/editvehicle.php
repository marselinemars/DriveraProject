...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title> Drivera | Edit Vehicle</title>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Vehicle Information </h4>
								<p class="mb-30">Please Enter The Vehicle Information Carefully</p>
						...
						<form id="vehicle_credentials" method="post" action=<?php echo "index.php?action=do_edit_vehicle&idvehicle=$idv" ?>  enctype="multipart/form-data">
                        <?php
						 $idv=$_GET["idvehicle"];
						 $vehicles= $db->query("SELECT * FROM vehicle where VehicleID= ? ", $idv)->fetchAll(); 
						 ?>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										...
										name="Make"
                                        value="<?php echo $vehicles [0] ['Make']; ?>"
									/>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
										placeholder="Enter the vehicles's Model"
										type="search"
										name="Model"
                                        value="<?php echo $vehicles [0] ['Model']; ?>"
									/>
								</div>
							</div>
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">License plate Number</label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
										placeholder="Enter the vehicles's License plate Number"
										type="search"
										name="LicenseplateNumber"
                                        value="<?php echo $vehicles [0] ['LicenseplateNum']; ?>"
									/>
								</div>
							</div>
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Num de chassis</label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
										placeholder="Enter the vehicles's Insurance Policy Number"
										type="search"
										name="InsurancePolicyNumber"
                                        value="<?php echo $vehicles [0] ['InsurancePolicyNumber']; ?>"
									/>
								</div>
							</div>
							...
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Insurance Expiry Date</label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
										placeholder="Enter the Insurance Expiry Date "
										type="date"
										name="InsuranceExpiryDate"
                                        value="<?php echo $vehicles [0] ['InsuranceExpiryDate']; ?>"
                            ...
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Technical Inspection Expiry Date</label>
								<div class="col-sm-12 col-md-10">
									<input
										class="form-control"
										placeholder="Enter the TechnicalInspectionExpiryDate "
										type="date"
										name="TechnicalInspectionExpiryDate"
                                        value="<?php echo $vehicles [0] ['TechnicalInspectionExpiryDate']; ?>"
								...
								<br><br><br>
									...
									<div class="wrapper">
										<button class="" type="submit" form="vehicle_credentials">
										  <span>Edit </span>
										  <div class="success">
