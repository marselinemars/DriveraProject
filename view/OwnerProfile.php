					...
					<div class="row">
						<div style="width:100%;">
							<div class="pd-20 card-box height-100-p">
								...
								<h5 class="text-center h5 mb-0"><?php echo htmlspecialchars($items[0]['lname']) . "  " . htmlspecialchars($items[0]['fname']) ;?></h5>
								<p class="text-center text-muted font-14">
									the owner of this driving school 
								</p>
								<div class="profile-info">
									<h5 class="mb-20 h5 text-blue">Owner Information</h5>
									<ul>
										<li>
									...
									<h5 class="mb-20 h5 text-blue">Driving School Information</h5>
									<ul>
									<li>
											<span>School Name:</span>
											<?php echo htmlspecialchars($driving_school[0]['Name']);?>
										</li>
										<li>
											<span>School number:</span>
											<?php echo htmlspecialchars($driving_school[0]['id']);?>
										</li>

										<li>
											<span>Full Address:</span>
											<?php echo htmlspecialchars($driving_school[0]['address']);?>
										</li>
